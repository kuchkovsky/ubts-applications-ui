  ...
  <section className={classes.section}>
    ...
    <Typography variant="body2" component="div" className={classes.sectionSubtext} gutterBottom>
      ...
      <b>Модульний (очно-заочний) формат</b>
        6000 грн. Оплата відбувається 2 рази на рік по 3000 грн., але студент має можливість
        отримати знижку 10%,, якщо оплачувати одразу за весь рік. В такому випадку сума пожертви
        становитиме 5400 грн. при оплаті за весь рік на початку навчального року.
        <br/>
