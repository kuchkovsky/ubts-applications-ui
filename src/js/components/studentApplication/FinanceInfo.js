...
const FinanceInfo = ({ classes }) => (
  <section className={classes.section}>
    ...
    <Typography variant="body2" component="div" className={classes.sectionSubtext} gutterBottom>
      ...
      становитиме 6600 грн. Оплата відбувається 2 рази на рік по 3300 грн., але студент
      має можливість отримати знижку, якщо оплачувати одразу
      за весь рік. ZВ такому випадку сума пожертви становитиме 5500 грн. при оплаті
      ...
      * Для студентів <b>Пасторської програми</b>, у зв’язку з особливостями навчання, пожертвування
      складає 8400/7500 грн. відповідно двома чи однією частинами.
    </Typography>
    <Field
