...
const HeaderInfo = ({ classes, registrationOpened }) => (
  <section className={classes.justify}>
    ...
    <Typography variant="body1" gutterBottom>
      ...
      загальну середню освіту) та додаток до нього, а також медичну довідку форми 086-у.У зв'язку
      із карантином дозволяється подати документи без медичної довідки, але вислати її нам
      електронною поштою до початку першої сесії. Для реєстрації на онлайн навчання медична довідка не потрібна.
      <br></br>
      <br></br>
