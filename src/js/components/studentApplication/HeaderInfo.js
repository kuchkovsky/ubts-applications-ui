...
const HeaderInfo = ({ classes, registrationOpened }) => (
  <section className={classes.justify}>
    ...
    <Typography variant="body1" gutterBottom>
      ...
      <br></br>
      Також розраховуйте, що на заповнення анкети вам знадобиться приблизно 1 година.
      В анкеті є питання трьох категорій: особиста інформація, питання про ваше
      навернення та духовне життя, а також тест на знання Біблії. Під час складання
      тесту просимо вас не користуватися Біблією та пошуком в інтернеті.
      Оптимальний час для складання тесту – 30 хвилин. Ви матимете лише 1 спробу.
    </Typography>
